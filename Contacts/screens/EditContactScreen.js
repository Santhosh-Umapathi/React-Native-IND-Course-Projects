...
export default class EditContactScreen extends React.Component {
  ...
  getContact = async key => {
    await AsyncStorage.getItem(key)
      .then(contactJsonString => {
        var contact = JSON.parse(contactJsonString); //Convert JSON String into JSON Object
  ...
  updateContact = async key => {
    if (
      ...
      await AsyncStorage.mergeItem(key, JSON.stringify(contact)) //Passing Key to update
